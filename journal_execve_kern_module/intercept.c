...
unsigned long *sys_call_table = (unsigned long*)0xffffffff81a001c0; //hard coded address of sys_call_table from /boot/System.map
...
{
	printk(KERN_INFO "interceptor: open(\"%s\", %X, %X)\n", file_name, flags, mode);
